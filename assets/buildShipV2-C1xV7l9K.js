import{n as e}from"./rolldown-runtime-QTnfLwEv.js";import{$ as t,C as n,Ct as r,D as i,H as a,O as o,Pt as s,R as c,S as l,St as u,T as d,a as f,bt as p,c as m,dt as h,ht as g,it as _,k as v,rt as y,tt as b,v as x,wt as S,y as C,yt as w,z as T}from"./three-Cp78jkzt.js";var E={ink:526343,amber:16098596,amberBright:16762977,amberDeep:15234586,coral:16735802},D=new s(600,400,250).normalize(),O=t.degToRad(.1),k=`
...
`;function Ye(){let e=document.createElement(`canvas`);e.width=128,e.height=128;let t=e.getContext(`2d`),r=t.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);r.addColorStop(0,`rgba(255,255,255,1)`),r.addColorStop(.35,`rgba(150,210,255,0.65)`),r.addColorStop(1,`rgba(80,160,255,0)`),t.fillStyle=r,t.fillRect(0,0,128,128);let i=new n(e);return i.needsUpdate=!0,i}function Xe(e){let n=new a;n.name=`engine-fx`;let o=new d(.4,24),c=new _({color:1581870,emissive:Q.clone(),emissiveIntensity:Ie,metalness:.6,roughness:.3}),l=Ye(),u=new S({map:l,color:Q.clone(),transparent:!0,depthWrite:!1,blending:2,opacity:.18}),f=[],p=[],m=Ke(),g=[];e.forEach((e,t)=>{let i=new b(o,c);i.position.copy(e),i.rotation.y=Math.PI,n.add(i);let a=new r(u);a.position.copy(e).add(new s(0,0,.22)),a.scale.set(.55,.55,1),a.visible=!1,n.add(a),f.push(a);let l=new w({uniforms:{uTime:{value:0},uThrust:{value:0},uPhase:{value:t%4*17.3},uColorCore:{value:We.clone()},uColorMid:{value:Ge.clone()}},vertexShader:qe,fragmentShader:Je,transparent:!0,depthWrite:!1,side:2,blending:2}),d=new b(m,l);d.position.copy(e).add(new s(0,0,.04)),d.scale.set($,$,Ve),d.renderOrder=5,n.add(d),g.push({mesh:d,mat:l});let _=new h(Q.getHex(),ze,40,2);_.position.copy(e).add(new s(0,0,1)),n.add(_),p.push(_)});let v=new i;return{group:n,nozzleMat:c,updateThrust(e,n){let r=t.clamp(e,0,1);v.copy(Q).lerp(Re,r);let i=t.lerp(Ie,Le,r);c.emissive.copy(v),c.emissiveIntensity=i,u.color.copy(v),u.opacity=t.lerp(.18,.48,r);let a=t.lerp(1.25,2.05,r);for(let e of f)e.scale.set(a,a,1);let o=t.lerp(ze,Be,r);for(let e of p)e.color.copy(v),e.intensity=o;let s=t.lerp(Ve,He,r),l=t.lerp($,Ue,r);for(let e of g)e.mesh.visible=r>.04,e.mesh.scale.set(l,l,s),e.mat.uniforms.uTime.value=n,e.mat.uniforms.uThrust.value=r},dispose(){o.dispose(),c.dispose(),u.dispose(),l.dispose(),m.dispose();for(let e of g)e.mat.dispose()}}}var Ze=e({buildShipV2:()=>Qe});async function Qe(e,t){let{hull:n,source:r}=await Fe(e,t),i=Xe(n.nozzleAttachPoints),o=new a;return o.name=`ship-root-v2`,o.userData.hullSource=r,o.add(n.group),o.add(i.group),{group:o,updateThrust(e,t){i.updateThrust(e,t)},dispose(){n.dispose(),i.dispose()}}}export{te as a,k as c,oe as d,E as i,A as l,Ze as n,ne as o,ee as r,O as s,Qe as t,ae as u};