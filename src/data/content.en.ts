...
export const projectsEn: Project[] = [
  ...
  },
  {
    ...
    domain: 'plumm.pl',
    url: 'https://plumm.pl',
    tagline: 'Accounting · invoicing · JPK export',
    description:
      'Plumm — an invoicing and accounting panel for small businesses: issuing documents, deterministic CSV/JPK exports and KSeF readiness, with MINTAX integration.',
    client: 'Small businesses · accounting offices',
    pain: 'Manual invoices and re-entering data into accounting software — errors at month-end close',
    approach: 'In-browser TypeScript, export adapters, validation before submission to the tax authority',
    result: 'Invoices and JPK from one panel on plumm.pl — no more late-night spreadsheets',
    tags: ['Accounting', 'Invoicing', 'KSeF'],
    accent: '#3ee8c4',
    stat: { value: 'JPK', label: 'export in one flow' },
    metrics: ['Invoicing', 'JPK / KSeF', 'MINTAX'],
  },
  {
    id: 'idrive',
    title: 'iDrive Cars',
...
export const testimonialsEn = [
  {
    quote:
      'The site finally looks like a premium product instead of a classifieds listing. Booking in Polish, English and German without a phone call — the guest just picks a date.',
    author: 'Marcin K.',
    role: 'owner · Mint Apartments (placeholder — pending consent)',
    year: '2026',
  },
  {
    quote:
      'One panel instead of five spreadsheets. I see bookings, the AI concierge and social in one place — the team no longer loses track between WhatsApp and email.',
    author: 'Operations team',
    role: 'Mint Apartments · admin panel (placeholder)',
    year: '2026',
  },
  {
    quote:
      "JPK export from Plumm takes a minute, not a weekend. The logic is predictable — I know exactly what reaches the accountant before I click send.",
    author: 'Anna M.',
    role: 'rental operator · MINTAX integration (placeholder)',
    year: '2026',
  },
]
