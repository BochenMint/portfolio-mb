    ...
    sections: [
      ...
      section(
        ...
        ol([
          ...
          'Nie używa I DRIVE CARS ani Agentic jako dowodu księgowego — nie ten produkt.',
        ]),
    ...
    sections: [
      ...
      section(
        ...
        ol([
          ...
          'It does not use I DRIVE CARS or Agentic as accounting proof — wrong product.',
        ]),
    ...
    sections: [
      ...
      section(
        ...
        ol([
          ...
          'Не використовує I DRIVE CARS чи Agentic як бухгалтерський доказ — не той продукт.',
        ]),
