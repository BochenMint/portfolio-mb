...
export const expandStrony = {
  ...
  'ile-kosztuje-strona-firmowa': {
    pl: [
      ...
      section(
        ...
        p('Pytaj, czy w kwocie jest copy od zera, zdjęcia, drugi język, opieka po starcie bez limitu, sklep. Pytaj o stack i o to, czy kod jest Twój. Pytaj, czy „SEO w cenie” znaczy title i sitemap, czy obietnicę pozycji. Ja pozycji nie sprzedaję. Sprzedaję stronę, która da się zmierzyć i która nie kłamie w ofercie. Reszta wycen, których nie umiem obronić na produkcji, nie jest moim problemem — dopóki nie porównujesz ich ze mną jak identycznych pudełek.'),
      ),
    ],
    en: [
      section(
      ...
      section(
        ...
        p('Ask whether the number includes copy from scratch, photos, a second language, unlimited post-launch care, a shop. Ask about the stack and whether the code is yours. Ask whether “SEO included” means title and sitemap, or a ranking promise. I do not sell rankings. I sell a site you can measure and an offer that does not lie. Other quotes I cannot defend in production are not my problem — until you compare them to me as identical boxes.'),
      ),
    ],
    uk: [
      section(
      ...
      section(
        ...
        p('Питайте, чи в сумі є копія з нуля, світлини, друга мова, догляд після старту без ліміту, магазин. Питайте про стек і чи код ваш. Питайте, чи «SEO в ціні» означає title і sitemap, чи обіцянку позиції. Я позицій не продаю. Продаю сайт, який можна виміряти, і оферту, яка не бреше. Інші оцінки, яких не вмію захистити на продакшені, не моя проблема — доки не порівнюєте їх зі мною як однакові коробки.'),
      ),
    ],
  },
    ...
    pl: [
      section(
        ...
        ul([
          ...
          'Panel: gdy Excel psuje proces — to już nie jest dylemat wizytówka/lejek.',
        ]),
      ),
      section(
      ...
      section(
        ...
        p('Pytam, skąd dziś przychodzą rozmowy i co się z nimi dzieje. Pytam, czy ktoś już płaci za klik. Pytam, czy konwersja to mail, rezerwacja czy „zostaw numer”. Jeśli nie umiecie tego nazwać, nie wybieramy lejka „na zapas”. Wybieramy wizytówkę albo nic. Nic jest legalną opcją. Oszczędza 25 tysięcy na ścieżkę, której nie obsłużycie follow-upem. Lejek na martwej skrzynce tylko przyspiesza wstyd.'),
        note('Mint jest żywym lejkiem rezerwacji na własnej domenie, nie wizytówką z galerią. Plumm jest produktem operacyjnym. Nie mieszam ich w jeden „uniwersalny case strony firmowej”.'),
      ),
    ],
    en: [
      section(
        ...
        ul([
          ...
          'Panel: when Excel breaks the process — that is no longer a brochure/funnel dilemma.',
        ]),
      ),
      section(
      ...
      section(
        ...
        p('I ask where conversations come from today and what happens to them. I ask whether anyone already pays for a click. I ask whether conversion is mail, a booking, or “leave a number”. If you cannot name that, we do not pick a funnel “just in case”. We pick a brochure or nothing. Nothing is a legal option. It saves 25k on a path you will not staff with follow-up. A funnel on a dead inbox only accelerates embarrassment.'),
        note('Mint is a live booking funnel on its own domain, not a brochure with a gallery. Plumm is an operations product. I do not mash them into one “universal company-site case”.'),
      ),
    ],
    uk: [
      section(
        ...
        ul([
          ...
          'Панель: коли Excel псує процес — це вже не дилема візитівка/воронка.',
        ]),
      ),
      section(
      ...
      section(
        ...
        p('Питаю, звідки сьогодні приходять розмови і що з ними діється. Питаю, чи хтось уже платить за клік. Питаю, чи конверсія — лист, бронювання чи «залиште номер». Якщо цього не вмієте назвати, не обираємо воронку «про запас». Обираємо візитівку або нічого. Нічого — легальна опція. Рятує 25 тисяч на шлях, який не закриєте follow-up. Воронка на мертвій скриньці лише прискорює сором.'),
        note('Mint — жива воронка бронювання на власному домені, не візитівка з галереєю. Plumm — операційний продукт. Не мішаю їх в один «універсальний кейс корпоративного сайту».'),
      ),
    ],
  },
  'dlaczego-strona-nie-sprzedaje': {
    pl: [
      section(
        'Wiadro 1: nikt nie przychodzi, a Wy winicie przycisk',
        p('Dlaczego strona nie sprzedaje — najpierw ruch. Jeśli nie ma zapytań, sprawdź Search Console albo choćby skrzynkę: czy ktokolwiek wpisuje nazwę firmy, czy blog o „trendach 2026” ciągnie ciekawskich bez budżetu. B2B nie żyje z sesji. Żyje z ludzi, którzy mogą kupić. Wizytówka bez kanału (polecenie, LinkedIn, płatny) nie „nie sprzedaje”. Ona nie ma kogo obsłużyć. Redesign tego nie naprawi. Naprawi go źródło albo decyzja, że strona jest potwierdzeniem po rozmowie, nie magnesem.'),
        p('Drugi wariant wiadra 1: ruch jest, ale zły. Wtedy H1 obiecuje coś innego niż oferta. Albo target kampanii jest szerszy niż to, co umiecie obsłużyć. Mierzycie sesje, nie zapytania, i wnioskujecie, że „strona nie sprzedaje”. Sprzedaje źle wycelowana treść. Dlatego w pakiecie strony firmowej nie ma bloga SEO. Blog bez klastra i crawlable URL-i jest hobby, nie lejkiem.'),
      ),
      section(
        'Wiadro 2 i 3: przychodzą i uciekają, albo piszą i giną',
        p('Wiadro 2 to INP, LCP, pierwszy ekran bez oferty, pięć CTA, brak ceny, brak dowodu. Gość nie rozumie, czy to dla niego, w pięć sekund na telefonie. [Szybkość](/artykuly/szybkosc-strony-a-seo/) jest tu narzędziem sprzedaży, nie ozdobą Lighthouse. Wiadro 3 to follow-up: formularz działa, mail ginie, SLA odpowiedzi to trzy dni. Wtedy nowy layout jest zakupem tapety. Potrzebujecie dyscypliny albo panelu zgłoszeń, nie fioletu.'),
        ol([
          'Nagranie mobile — albo ja wchodzę na swoim telefonie.',
          'Ścieżka maila po submit: kto, kiedy, jakim szablonem.',
    ...
    en: [
      section(
        'Bucket 1: nobody comes, and you blame the button',
        p('Why a website does not sell — traffic first. If there are no enquiries, check Search Console or at least the inbox: does anyone type the company name, or does a “trends 2026” blog pull the curious with no budget. B2B does not live on sessions. It lives on people who can buy. A brochure with no channel (referral, LinkedIn, paid) is not “failing to sell”. It has nobody to serve. A redesign will not fix that. A source will, or a decision that the site confirms a conversation rather than acting as a magnet.'),
        p('A second variant of bucket 1: traffic exists, but it is the wrong kind. Then the H1 promises something other than the offer. Or the campaign target is wider than you can serve. You measure sessions, not enquiries, and conclude the “site does not sell”. Badly aimed content sells. That is why the company-site package has no SEO blog. A blog without a cluster and crawlable URLs is a hobby, not a funnel.'),
      ),
      section(
        'Buckets 2 and 3: they arrive and leave, or they write and die',
        p('Bucket 2 is INP, LCP, a first screen with no offer, five CTAs, no price, no proof. The guest cannot tell in five seconds on a phone whether this is for them. [Speed](/artykuly/szybkosc-strony-a-seo/) is a sales tool here, not Lighthouse decoration. Bucket 3 is follow-up: the form works, mail dies, reply SLA is three days. Then a new layout is wallpaper. You need discipline or a ticket panel, not purple.'),
        ol([
          'A mobile recording — or I open it on my phone.',
          'The mail path after submit: who, when, which template.',
    ...
    uk: [
      section(
        'Відро 1: ніхто не приходить, а ви вините кнопку',
        p('Чому сайт не продає — спочатку трафік. Якщо немає запитів, перевірте Search Console або хоча б скриньку: чи хтось вводить назву фірми, чи блог про «тренди 2026» тягне цікавих без бюджету. B2B не живе сесіями. Живе людьми, які можуть купити. Візитівка без каналу (рекомендація, LinkedIn, платний) не «не продає». Їй немає кого обслужити. Редизайн цього не полагодить. Полагодить джерело або рішення, що сайт підтверджує розмову, а не є магнітом.'),
        p('Другий варіант відра 1: трафік є, але поганий. Тоді H1 обіцяє не те, що оферта. Або таргет кампанії ширший, ніж ви вмієте обслужити. Міряєте сесії, не запити, і робите висновок, що «сайт не продає». Продає погано націлений контент. Тому в пакеті корпоративного сайту немає блогу SEO. Блог без кластера і crawlable URL — хобі, не воронка.'),
      ),
      section(
        'Відра 2 і 3: приходять і тікають, або пишуть і гинуть',
        p('Відро 2 — INP, LCP, перший екран без оферти, п’ять CTA, немає ціни, немає доказу. Гість за п’ять секунд на телефоні не розуміє, чи це для нього. [Швидкість](/artykuly/szybkosc-strony-a-seo/) тут інструмент продажу, не прикраса Lighthouse. Відро 3 — follow-up: форма працює, пошта гине, SLA відповіді три дні. Тоді новий макет — покупка шпалер. Потрібна дисципліна або панель звернень, не фіолетовий.'),
        ol([
          'Запис mobile — або я заходжу на своєму телефоні.',
          'Шлях пошти після submit: хто, коли, яким шаблоном.',
    ...
    pl: [
      section(
        ...
        ul([
          ...
          'Zdarzenia, które da się odczytać po tygodniu, nie „jakoś w Analytics”.',
          'Follow-up z SLA. Lejek bez człowieka po drugiej stronie to ozdoba.',
        ]),
      ),
      section(
    ...
    en: [
      section(
        ...
        ul([
          ...
          'Events you can read after a week, not “somehow in Analytics”.',
          'Follow-up with an SLA. A funnel with no human on the other side is decoration.',
        ]),
      ),
      section(
    ...
    uk: [
      section(
        ...
        ul([
          ...
          'Події, які можна прочитати за тиждень, не «якось в Analytics».',
          'Follow-up з SLA. Воронка без людини з того боку — прикраса.',
        ]),
      ),
      section(
    ...
    pl: [
      section(
        ...
        ul([
          ...
          'Mobile: rezerwacja, która wymaga pinch-zoom, wraca na OTA.',
          'Mail potwierdzenia, który dochodzi. Lejek bez maila jest dziurawy.',
        ]),
      ),
      section(
        'Kiedy zostawić Booking jako kasę i nie udawać „direct-first”',
        p('Nowy obiekt bez marki, bez powracających gości, bez budżetu na kampanię — najpierw obłożenie, potem direct. Strona wtedy jest wizytówką z jasnym „zarezerwuj”, które może prowadzić na OTA albo na widget PMS, byle nie kłamać w cenie. Direct-first ma sens, gdy liczycie prowizję jako koszt, który już boli, i macie kogo obsłużyć po stronie maila i zameldowania. Inaczej zbudujecie ładną kasy, do której nikt nie podejdzie.'),
        p('Nie obiecuję, że „strona zastąpi Booking w 90 dni”. Obiecuję ścieżkę, którą gość przejdzie na Waszej domenie, i integrację, której nie udaję, że napisałem od zera. Jeśli ktoś sprzedaje własny silnik rezerwacji w cenie wizytówki — pytajcie, kto pilnuje overbookingu w sobotę o 23:00. Ja chcę, żeby to był system, który już to robi, nie mój weekend.'),
      ),
    ],
    en: [
      section(
        ...
        ul([
          ...
          'Mobile: a booking that needs pinch-zoom returns to the OTA.',
          'A confirmation mail that arrives. A funnel without mail is leaky.',
        ]),
      ),
      section(
        'When to leave Booking as the till and not pretend “direct-first”',
        p('A new property with no brand, no returning guests, no campaign budget — occupancy first, then direct. The site is then a brochure with a clear “book” that may point at an OTA or a PMS widget, as long as the price does not lie. Direct-first makes sense when you already feel commission as a cost, and you have someone to handle mail and check-in. Otherwise you will build a pretty till nobody walks up to.'),
        p('I do not promise the “site will replace Booking in 90 days”. I promise a path the guest can finish on your domain, and an integration I do not pretend I wrote from scratch. If someone sells a homemade booking engine at brochure price — ask who watches overbooking on Saturday at 23:00. I want that to be a system that already does it, not my weekend.'),
      ),
    ],
    uk: [
      section(
        ...
        ul([
          ...
          'Mobile: бронювання, яке потребує pinch-zoom, вертається на OTA.',
          'Лист підтвердження, який доходить. Воронка без пошти дірява.',
        ]),
      ),
      section(
        'Коли лишити Booking касою і не вдавати «direct-first»',
        p('Новий об’єкт без марки, без постійних гостей, без бюджету на кампанію — спочатку завантаження, потім direct. Сайт тоді візитівка з ясним «забронювати», яке може вести на OTA або віджет PMS, аби не брехати в ціні. Direct-first має сенс, коли комісія вже болить як вартість, і є кому обслужити пошту й заселення. Інакше збудуєте гарну касу, до якої ніхто не підійде.'),
        p('Не обіцяю, що «сайт замінить Booking за 90 днів». Обіцяю шлях, який гість пройде на вашому домені, і інтеграцію, яку не вдаю, що написав з нуля. Якщо хтось продає власний рушій бронювання в ціні візитівки — питайте, хто стереже overbooking у суботу о 23:00. Я хочу, щоб це була система, яка вже це робить, не мої вихідні.'),
      ),
    ],
  },
}
