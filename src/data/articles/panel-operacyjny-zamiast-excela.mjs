...
export default {
  ...
  pl: {
    ...
    description:
      'Panel operacyjny zamiast Excela ma sens, gdy kilka osób psuje jeden plik i proces się powtarza. Widełki Ops 60 000–180 000+ zł. Piszę, kiedy zostawić arkusz, a kiedy budować system.',
    h1: 'Panel operacyjny zamiast Excela: kiedy arkusz kłamie, a system ma prawo kosztować',
    kicker: 'Ops System',
    lead:
      'Excel nie jest wrogiem. Wrogiem jest Excel udający ERP, CRM, kalendarz i kasę jednocześnie, gdy w pliku siedzi pięć osób i nikt nie wie, która kopia jest prawdziwa. Panel operacyjny, który wdrażam, kosztuje 60 000–180 000+ zł, bo to nie „ładniejsza tabela w przeglądarce”. Poniżej progi, przy których mówię „zostaw arkusz” — i te, przy których arkusz już kradnie godziny.',
    sections: [
      section(
        ...
        p('Jeśli rozpoznajesz dwa punkty, rozmawiamy. Jeśli jeden — często wystarczy porządek w arkuszu albo gotowiec. Nie sprzedaję panelu z przyzwyczajenia. [Audit Sprint](/artykuly/audyt-strony-internetowej/) (2 500–6 000 zł) istnieje po to, żeby nie kodować żalu za 80 tysięcy.'),
      ),
      section(
        ...
        table(
          ['Sytuacja', 'Zostaw Excel / gotowiec', 'Buduj panel (Ops)'],
          [
            ...
            ['Budżet', '< 25 tys. i spokój', '60–180 tys.+ i mierzalne „przed/po”'],
          ],
        ),
      ...
      section(
        ...
        p('Ops System: 60 000–180 000+ zł. W tej kwocie: panel albo aplikacja dla zespołu, połączenia z płatnościami / kalendarzami / e-fakturami, automatyzacja z limitami i zapisem, staging, szkolenie, pomiar po starcie. To nie jest [strona firmowa za 6 500–12 000](/artykuly/ile-kosztuje-strona-firmowa/). Ktoś, kto „wrzuci Excel do Airtable za weekend”, robi inny produkt — często bez ról, bez audytu, bez eskalacji.'),
    ...
    faqs: [
      ...
      { q: 'Czy mogę zacząć od wycinka?', a: 'Tak. Jeden bolesny przepływ, pomiar, dopiero wtedy reszta. Wielki bang za 180 tys. bez wycinka to ryzyko, którego nie biorę w ciemno.' },
  ...
  en: {
    ...
    sections: [
      section(
        ...
        p('If you recognise two points, we talk. If one — often a tidier sheet or an off-the-shelf tool is enough. I do not sell a panel out of habit. [Audit Sprint](/artykuly/audyt-strony-internetowej/) (PLN 2,500–6,000) exists so we do not code regret for 80k.'),
      ),
      section(
        ...
        table(
          ['Situation', 'Keep Excel / off-the-shelf', 'Build a panel (Ops)'],
          [
            ...
            ['Budget', '< 25k and calm', '60–180k+ and a measurable before/after'],
          ],
        ),
      ...
      section(
        ...
        p('Ops System: PLN 60,000–180,000+. In that range: a panel or a team app, connections to payments / calendars / e-invoices, automation with limits and a log, staging, training, post-launch measurement. That is not a [company site at 6,500–12,000](/artykuly/ile-kosztuje-strona-firmowa/). Someone who “drops Excel into Airtable over a weekend” ships a different product — often without roles, audit trail or escalation.'),
    ...
    faqs: [
      ...
      { q: 'Can we start with a slice?', a: 'Yes. One painful flow, measurement, then the rest. A 180k big bang without a slice is a risk I will not take blind.' },
  ...
  uk: {
    ...
    description:
      'Операційна панель замість Excel має сенс, коли кілька людей псують один файл і процес повторюється. Вилка Ops 60 000–180 000+ злотих. Пишу, коли лишити аркуш, а коли будувати систему.',
    h1: 'Операційна панель замість Excel: коли аркуш бреше, а система має право коштувати',
    kicker: 'Ops System',
    lead:
      'Excel не ворог. Ворог — Excel, що вдає ERP, CRM, календар і касу одночасно, коли у файлі сидить п’ятеро людей і ніхто не знає, яка копія правдива. Операційна панель, яку впроваджую, коштує 60 000–180 000+ злотих, бо це не «гарніша таблиця в браузері». Нижче пороги, на яких кажу «лишіть аркуш» — і ті, на яких аркуш уже краде години.',
    sections: [
      section(
        ...
        p('Якщо впізнаєте два пункти — розмовляємо. Якщо один — часто досить ладу в аркуші або готового інструменту. Не продаю панель зі звички. [Audit Sprint](/artykuly/audyt-strony-internetowej/) (2 500–6 000) існує, щоб не кодувати жаль за 80 тисяч.'),
      ),
      section(
        ...
        table(
          ['Ситуація', 'Лишити Excel / готове', 'Будувати панель (Ops)'],
          [
            ...
            ['Бюджет', '< 25 тис. і спокій', '60–180 тис.+ і вимірюване «до/після»'],
          ],
        ),
      ...
      section(
        ...
        p('Ops System: 60 000–180 000+ злотих. У цій сумі: панель або застосунок для команди, з’єднання з платежами / календарями / e-фактурами, автоматизація з лімітами й записом, staging, навчання, вимір після старту. Це не [корпоративний сайт за 6 500–12 000](/artykuly/ile-kosztuje-strona-firmowa/). Хтось, хто «закине Excel в Airtable за вихідні», робить інший продукт — часто без ролей, аудиту, ескалації.'),
    ...
    faqs: [
      ...
      { q: 'Чи можна почати з фрагмента?', a: 'Так. Один болісний потік, вимір, лише тоді решта. Великий вибух за 180 тис. без фрагмента — ризик, якого не беру наосліп.' },
