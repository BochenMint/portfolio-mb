...
export const expandClose = {
  ...
  'automatyzacja-z-kontrola-czlowieka': S(
    ...
    section(
      ...
      p('The HITL package in the offer is engineering, not an AI sticker on a brochure. A PLN 6,500–12,000 company site does not include it. If the budget is only a site, first the form and follow-up. Speeding up chaos is not transformation. A 20-minute audit may end as “do not automate yet”. That is control. The rest is seat theatre.'),
    ),
    section(
