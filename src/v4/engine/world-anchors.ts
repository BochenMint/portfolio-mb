...
export type PlanetSlot = {
  id: PlanetId
  /** World position, orbital radius 400–900 units from the black hole. */
...
// flight has clear, distinct waypoints. Radii spread 400–900u, heights vary so the
// ship has to pitch/roll between them rather than skim one flat plane.
export const PLANET_SLOTS: PlanetSlot[] = [
  {
    id: 'mint',
    position: new THREE.Vector3(560, 90, -260),
    radius: 40,
    color: 0x2dd4bf,
  },
  {
    id: 'plumm',
    position: new THREE.Vector3(-420, -140, 520),
    radius: 34,
    color: 0x8a6bff,
  },
  {
    id: 'idrive',
    position: new THREE.Vector3(300, 220, 840),
    radius: 28,
    color: 0xffc861,
  },
  {
    id: 'agentic',
    position: new THREE.Vector3(-780, -60, -600),
    radius: 45,
    color: 0xf5a524,
  },
]
