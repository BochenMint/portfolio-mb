        ...
        {projects.map((project, index) => {
          ...
          return (
            ...
            >
              <div
                data-case-image
                className="bleed-full project-card-media relative aspect-[16/9] overflow-hidden bg-[var(--color-surface)] md:aspect-auto md:min-h-[70vh] lg:min-h-[72vh]"
              >
                <ProjectImageInteractive
                  project={project}
                  variant="hero"
                  interaction={project.flagship ? 'hero' : 'strong'}
                  className="h-full min-h-[inherit] w-full rounded-none object-cover"
                />
